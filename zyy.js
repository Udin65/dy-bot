...
let buton = [
{ callButton: {displayText: `Instagram`, url: `https://www.instagram.com/xauddy123/`} },
{ urlButton: { displayText: `Call Owner`,phoneNumber : `+6285719898124`} },
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                urlButton: {
                                    ...
                                    url: 'https://instagram.com/Dpi.xauddy'
                                }
                            }, {
                                callButton: {
...
m.reply('*Join To Group Official Jb  : https://chat.whatsapp.com/KMzBn7w17JfDXYmwowt87v*')
break
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
    ...
    + 'FN:ZyyXtrime\n'
    + 'ORG:ZyyXtrime;\n'
    + 'item1.TEL;type=CELL;type=VOICE;waid=625719898124:+62 895-0365-7396\n' 
    + 'item1.X-ABLabel:Creator DY-bot\n'
